  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen relative p-16 pb-0 px-3">
      ...
      <div className="flex-grow w-full p-11 pt-0 relative grid grid-cols-1 lg:grid-cols-2 gap-14 z-10">
        ...
        <div className="min-h-screen h-full w-[45vw] p-11 pt-14 fixed top-10 right-0 hidden lg:block">
          <div
            ...
            {images.map((img, index) => {
              return (
                <img
                  ...
                  key={index}
                  draggable={false}
                  className={`w-11/12 absolute transition-transform mx-[calc(100%/24)] rounded-lg object-left-top object-cover shadow-[0px_0px_10px_10px_#635f5f42] ${
                    index === 0 ? "mt-[27.45%]" : "mt-[110%]"
                  }`}
                  ref={img.ref}
                />
              );
